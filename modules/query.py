...
def queryserver(self, serverhost, queryport):  # pylint: disable=unused-argument
    ...
    def assign_map_view_pic(self):
        ...
        self.c.execute("select map_pic FROM map_config WHERE map_name=:map_view_result", {
        ...
        if dpmap_alias is not None:
            ...
            self.c.execute("select self_added FROM map_config WHERE map_name=:map_view_result", {
                            'map_view_result': map_view_pic})
